package com.techknife.serviceImpl;
...
import com.techknife.mapper.EmployeeMapper;
import com.techknife.repository.EmployeeRepository;
...
@Service("comTechknifeEmployeeServiceImpl")
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public EmployeeServiceImpl(EmployeeRepository employeeRepository,
                               @Qualifier("comTechknifeEmployeeMapper") EmployeeMapper employeeMapper) {
