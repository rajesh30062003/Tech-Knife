package com.techknife.controller;
...
import com.techknife.service.EmployeeService;
...
@RestController("comTechknifeEmployeeController")
@RequestMapping("/employees")
@Tag(name = "Employee Management (Root)", description = "Enterprise Staff Directory, Onboarding, Profile Updates, and Organizational Hierarchy")
public class EmployeeController {

    private final EmployeeService employeeService;

    public EmployeeController(@Qualifier("comTechknifeEmployeeServiceImpl") EmployeeService employeeService) {
